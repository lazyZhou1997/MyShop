...
public class CartException extends RuntimeException {
    ...
    public static final int WRONG_PRODUCT_NUMBER = 407;
    public static final int UNKNOWN_ERROR = 408;
    ...
    public static final String WRONG_PRODUCT_NUMBER_MESSAGE = "商品数量错误";
