...
public class ProductException extends RuntimeException {
    ...
    public static final String PRODUCT_NAME_EMPTY_MESSAGE = "Product name is empty.";
    public static final String PRODUCT_PRICE_EMPTY_MESSAGE = "Product price is empty.";
    public static final String PRODUCT_TOTAL_EMPTY_MESSAGE = "Product left total is empty.";
